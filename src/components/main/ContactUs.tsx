...
const ContactUs: FC = () => {
  ...
  // ✅ Safe clipboard copy function (works in every environment)
  const copyToClipboard = async (text: string, label: string) => {
    try {
      // Modern API (secure or localhost)
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">
                    raedchebbi.work@gmail.com
                  </span>
                  <button
                    onClick={() => copyToClipboard('raedchebbi.work@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+216 23 743 004 </span>
                  <button
                    onClick={() => copyToClipboard('+216 23 743 004', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Tunis, Tunisia</span>
                </div>
              </div>
            </motion.div>
